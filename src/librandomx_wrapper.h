...
//
extern _Bool VerifyEticaRandomXNonce(unsigned char* blockHeader, size_t blockHeaderLength, unsigned char* nonce, size_t nonceLength, unsigned char* target, size_t targetLength);
